...
- [x] Accesso RunPod e secret Hugging Face configurati senza esposizione locale o nei log.
- [x] Tutti i 100 slot sono contabilizzati o la run è fermata al limite di 10 USD.
