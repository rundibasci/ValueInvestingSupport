...
### Phase TA3: Capability Benchmark on Vertex AI Gemini (replaces TRAIN-05)
...
- Deliverable: `vis-model-training/datasets/benchmark/real-ticker-knowledge-leakage-v1.jsonl`, `vis-model-training/reports/vertex-gemini/capability-benchmark-v1/`.
