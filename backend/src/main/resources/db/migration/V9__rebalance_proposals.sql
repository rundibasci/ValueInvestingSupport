CREATE TABLE rebalance_proposal (
    id UUID NOT NULL DEFAULT gen_random_uuid(), portfolio_id UUID NOT NULL,
...
CREATE TABLE rebalance_line (
    id UUID NOT NULL DEFAULT gen_random_uuid(), proposal_id UUID NOT NULL, symbol VARCHAR(20) NOT NULL,
