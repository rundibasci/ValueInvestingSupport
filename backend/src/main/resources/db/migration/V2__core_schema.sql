...
-- Partitioned by quote_date (monthly); FK on partitioned tables supported in PostgreSQL 12+
...
CREATE TABLE price_quote_2025 PARTITION OF price_quote
    FOR VALUES FROM ('2025-01-01') TO ('2026-01-01');
CREATE TABLE price_quote_2026 PARTITION OF price_quote
    FOR VALUES FROM ('2026-01-01') TO ('2027-01-01');
CREATE TABLE price_quote_2027 PARTITION OF price_quote
